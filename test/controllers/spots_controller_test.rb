...
class SpotsControllerTest < ActionController::TestCase
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post :create, spot: { address: @spot.address, latitude: @spot.latitude, longitude: @spot.longitude }
    end
  ...
  test "should update spot" do
    patch :update, id: @spot, spot: { address: @spot.address, latitude: @spot.latitude, longitude: @spot.longitude }
    assert_redirected_to spot_path(assigns(:spot))
  end
